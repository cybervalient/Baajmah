...
%         b = q.combinations{1,i}(VectPosCantComb(i,1));

 %       disp(b);
        VTiempos(i) = McombVehiculos(q.combinations{1,i}(VectPosCantComb(i,1)),1,i)'; 
        VCantidadVehiculo(i) = McombVehiculos(q.combinations{1,i}(VectPosCantComb(i,1)),2,i)';
    end
